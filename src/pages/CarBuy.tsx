      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          ...
          <div style={{ paddingBottom: 36 }}>
            {loading ? (
              <div style={{ textAlign: 'center', color: '#01a3fc', padding: '80px 0', fontFamily: 'system-ui, sans-serif' }}>Loading listings...</div>
            ) : filtered.length === 0 ? (
              <div style={{ textAlign: 'center', color: '#01a3fc', padding: '80px 0', fontFamily: 'system-ui, sans-serif' }}>No listings match your filters.</div>
            ) : (
              <div style={{
                display: 'grid',
